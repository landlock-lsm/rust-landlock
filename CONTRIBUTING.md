...
[`compat.rs:current_kernel_abi()`][currentkernelabi].

For more information about Landlock ABIs, see: [landlockabi]

[currentkernelabi]: https://github.com/landlock-lsm/rust-landlock/blob/main/src/compat.rs
[landlockabi]: https://landlock.io/rust-landlock/landlock/enum.ABI.html

## Licensing & DCO

rust-landlock is double-licensed under the terms of [the Apache 2.0 license][apache-2.0]
and the terms of [the MIT license](https://spdx.org/licenses/MIT.html).

All changes submitted to rust-landlock must be signed off, in line with the
standards of the [the Linux kernel][linux-dco].

[apache-2.0]: https://spdx.org/licenses/Apache-2.0.html
[mit]: https://spdx.org/licenses/MIT.html
[dco]: https://developercertificate.org/
[linux-dco]: https://wiki.linuxfoundation.org/dco
